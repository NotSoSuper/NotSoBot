...
bubbles = ['img/png/bubbles/' + i for i in os.listdir('img/png/bubbles/') if i != 'Thumbs.db']
windows = ['img/png/windows/' + i for i in os.listdir('img/png/windows/') if i != 'Thumbs.db']
backgrounds = ['img/png/background/' + i for i in os.listdir('img/png/background/') if i != 'Thumbs.db']
